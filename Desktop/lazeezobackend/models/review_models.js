...
updateReview:function(id,Review,callback){
  return db.query("update review_tbl set fk_user_email=?,fk_rest_id=?,review_message=?,review_date=? where review_id=?",[Review.fk_user_email,Review.fk_rest_id,Review.review_message,Review.review_date],callback);
 }
