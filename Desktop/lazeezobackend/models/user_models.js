...
updateUser:function(id,User,callback){
  return db.query("update user_tbl set user_email=?,user_name=?,password=?,address=?,mobile_no=?,gender=?,city=?,pro_pic=?,DOB=? where table_id=?",[User.user_email,User.user_name,User.password,User.address,User.mobile_no,User.gender,User.city,User.pro_pic,User.DOB],callback);
 }
